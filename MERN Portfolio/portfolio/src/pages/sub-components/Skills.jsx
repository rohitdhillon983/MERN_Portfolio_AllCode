          ...
          {Loader ?(
            ...
            {skills &&
              skills.map((element) => {
                // console.log(skills)
                return (
                  <div className="container relative transition-all border-2 rounded-md bg-[#ffffff60]
                  overflow-hidden hover:bg-[#5656573d] flex flex-col justify-center items-center text-center 
                  lg:w-[250px] sm:w-[100px] SkillsContent2 p-3 ">
                    <div>
                        <img
                        ...
                        />
                        <p className="my-3 text-2xl sm:text-xl">{element.title}</p>
                    </div>
                    <Line percent={element.proficiency} strokeWidth={3} trailWidth={3} trailColor="#ff2972" strokeColor="#D3D3D3" />
