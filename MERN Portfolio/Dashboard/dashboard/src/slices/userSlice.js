...
const userSlice = createSlice({
    ...
    reducers:{
        ...
        updatePasswordRequestRequest(state,action){
            state.loading = true;
        ...
        updatePasswordRequestFailed(state,action){
            state.loading = false;
            state.message=null
            state.isUpdated = false;
            state.error = action.payload
...
export const updatePassword=(currentPassword,newPassword,confirmPassword)=>async(dispatch)=>{
    dispatch(userSlice.actions.updatePasswordRequestRequest());
    try {
        ...
        dispatch(
            userSlice.actions.updatePasswordRequestFailed(error.response.data.message)
        )
    }
}
