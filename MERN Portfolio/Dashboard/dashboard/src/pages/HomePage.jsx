import { clearAllUserErrors, logout } from "@/slices/userSlice";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@radix-ui/react-tooltip";
import { FolderGit, History, HomeIcon, LayoutGrid, LogOut, MessageSquareMore, MessageSquareMoreIcon, Package2, PanelLeft, PencilRuler, User,NotebookIcon } from "lucide-react";
    ...
    return(
        <div >
            <aside className="fixed inset-y-0 left-0 hidden w-14 flex-col border-r bg-background sm:flex z-50">
                ...
                <Link className="group flex h-9 w-9 mb-6 shrink-0 items-center justify-center gap-2 rounded-full bg-primary text-lg font-semibold text-primary-foreground md:h-8 md:w-8 md:text-base">
