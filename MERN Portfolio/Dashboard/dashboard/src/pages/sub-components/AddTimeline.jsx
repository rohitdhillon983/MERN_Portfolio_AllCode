...
import { AddNewTimeline, clearAllTimelineErrors, getAllTimeline, resetTimelineSlice} from "../../slices/timelineSlice"
        ...
        <div className="flex justify-center items-center mt-8 min-h-[100vh] sm:gap-4 sm:py-4 sm:pl-14">
          ...
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              <h2 className="text-[2rem]/7 font-semibold text-gray-900">Add New Timeline</h2>
